...
<div class="row">
	<div class="col-md-8 mb-4">
		<div class="card shadow">
			<a href="#collKeterangan" class="d-block card-header pt-3 pb-2 bg-abumuda <?php /*echo ($surat['id_status'] == 10) ? "collapsed" : ""*/ ?>" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collKeterangan">
				<p class="h6 font-weight-bold text-white">Keterangan</p>
			</a>
			<div class="collapse<?php /*($surat['id_status'] == 10) ? "" : " show"*/ ?>" id="collKeterangan">
				<div class="card-body">
					...
					<?php echo form_open(base_url('mahasiswa/surat/tambah/' . $pengajuan), '') ?>
					...
					foreach ($pengajuan_fields as $pengajuan_field) {
						...
						<div class="form-group row">
							...
							<div class="col-md-7">
								<?php generate_form_field($pengajuan_field['field_id'], $pengajuan_field['id_status']); ?>
							</div>
						</div>

					<?php  }  ?>

					<?php if ($pengajuan_field['id_status'] == 4) { ?>
						<input type="hidden" name="revisi" value="1">
						<input class="btn btn-lg btn-<?= $pengajuan_field['badge']; ?> btn-block" type="submit" name="submit" value="<?= ($pengajuan_field['id_status'] == '4') ? " Kirim Revisi Data" : "Ajukan Surat " . $pengajuan_field['Jenis_Pengajuan']; ?>" />

					<?php } elseif ($pengajuan_field['id_status'] == 1) { ?>
						<input class="btn btn-lg btn-<?= $pengajuan_field['badge']; ?> btn-block" type="submit" name="submit" value="Ajukan Surat <?= $pengajuan_field['Jenis_Pengajuan']; ?>" />
					<?php } ?>
	...
	<div class="col-md-4">
		...
		<div class="card shadow">
			<a href="#collStatus" class="d-block card-header pt-3 pb-2 bg-<?php /*echo $surat['badge'];*/ ?>" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collStatus">
				<p class="h5 text-center font-weight-bold text-white"> <?php /*echo $surat['status'];*/ ?> </p>
			</a>
			<div class="collapse show" id="collStatus">
				<div class="card-body pl-2">
					<ul class="timeline">
						...
						<li>
							<span class="badge badge-<?php /*echo $tl['badge'];*/ ?>"><?php /*echo $tl['status'];*/ ?>diterima</span>
							<span class="badge badge-secondary"><?php /*echo $tl['date'];*/ ?>25/11/2020</span>
							<span class="badge badge-perak"><?php /*echo $tl['time'];*/ ?>11:33</span>
						</li>
						<?php/* } */ ?>
					</ul>
				</div>
